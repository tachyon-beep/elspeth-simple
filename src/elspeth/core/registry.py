...
from elspeth.plugins.datasources import BlobDataSource, CSVDataSource
from elspeth.plugins.llms import AzureOpenAIClient, MockLLMClient, OpenRouterClient
...
class PluginRegistry:
    def __init__(self):
        ...
        self._llms: Dict[str, PluginFactory] = {
            ...
            "openrouter": PluginFactory(
                create=lambda options: OpenRouterClient(**options),
                schema={
                    "type": "object",
                    "properties": {
                        "config": {"type": "object"},
